    ...
    public static partial class RulesExtensions
    {
        public static void AddBasicRules (this IRules rules, bool overwrite = false)
        {
            var basicRules = new List<Rule>(){
                ...
                new Rule(typeof(Guid),          "", g => g.RandomGuid(),                                            "Guid",      "Returns a Guid" ),
                new Rule(typeof(bool?),         "", g => g.OnceEvery(6) ? null : (bool?)(g.RowNumber % 2 == 0),     "Bool?",     "Returns alternating true & false (1 in 6 NULL)"),
                new Rule(typeof(int?),          "", g => g.OnceEvery(6) ? null : (int?) g.RowNumber,                "Int?",      "Returns RowNumber (1 in 6 NULL)"),
                new Rule(typeof(long?),         "", g => g.OnceEvery(6) ? null : (long?) g.RowNumber,               "Long?",     "Returns RowNumber (1 in 6 NULL)"),
                new Rule(typeof(double?),       "", g => g.OnceEvery(6) ? null : (double?) g.RowNumber,             "Double?",   "Returns RowNumber (1 in 6 NULL)"),
                new Rule(typeof(decimal?),      "", g => g.OnceEvery(6) ? null : (decimal?) g.RowNumber,            "Decimal?",  "Returns RowNumber (1 in 6 NULL)"),
                new Rule(typeof(DateTime?),     "", g => g.OnceEvery(6) ? null : (DateTime?) g.BaseDateTime,        "DateTime?", "Returns BaseDateTime (1 in 6 NULL)")
            };
