    ...
    #region Get Rules
        ...
        protected List<Rule> GetAdvancedRules ()
        {
            ...
            return new List<Rule>(){
                ...
                new Rule(typeof(string),    "%city%",                           g => func.RandomElement(g, "City"),             "City",                 "Random city" ),
                new Rule(typeof(string),    "%county%",                         g => func.RandomElement(g, "County"),           "County",               "Random county" ),
