    ...
    public class MultiGenerator : Generator, IGenerator 
    {
        ...
        protected List<Rule> GetBasicRules()
        {
            ...
            return new List<Rule>(){
                ...
                //new Rule(typeof(IList<object>), "", g => EmptyIList(g),                                                 "EmptyIList","Returns empty list by default")
            };
        }
        ...
        protected List<Rule> GetAdvancedRules()
        {
            ...
            return new List<Rule>(){
                ...
                new Rule(typeof(string),    "%company%,%business%,%account%",   g => RandomCompany(g),                     "Company/Business",     "Random company/business" ),
        ...
        //public IList<object> EmptyIList (IGenerator generator)
        //{
        //    dynamic emptyIList = Activator.CreateInstance(generator.CurrentProperty.PropertyType);
        //    return emptyIList;
        //}
