...
namespace SeedPacket.Functions
{
    public static partial class Funcs
    {
        ...
        public static List<T> GetCacheItemsNext<T> (IGenerator generator, string cacheListName, int min, int max, bool remove = true)
        {
            ...
            return GetCacheItemsNext<T>(generator, cacheList, min, max, remove);
        }
